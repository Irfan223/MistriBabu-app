...
type Radius = 3 | 5 | 10 | 20;
interface WorkerSummary { trade: string; total_available: number; closest_distance_km: number; }
interface Technician { id: string; name: string; phone: string; trade: string; distance_km: number; latitude: number; longitude: number; }
